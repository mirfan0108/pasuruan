...
$(function () {
    ...
    var opts = {
          ...
          limitMax: false,     // If false, the max value of the gauge will be updated if value surpass max
          limitMin: false,     // If true, the min value of the gauge will be fixed unless you set it manually
          colorStart: 'rgb(24, 107, 42)',   // Colors
          colorStop: 'rgb(24, 107, 42)',    // just experiment with them
          strokeColor: '#E0E0E0',  // to see which ones work best for you
          generateGradient: true,
          highDpiSupport: true     // High resolution support
        };
    ...
    var sparklineLogin = function() { 
        ...
        $("#spark1").sparkline([2,4,4,6,8,5,6,4,8,6,6,2 ], {
            ...
            width: '100%',
            height: '50',
            lineColor: 'rgb(24, 107, 42)',
            fillColor: 'rgb(24, 107, 42)',
            maxSpotColor: 'rgb(24, 107, 42)',
            highlightLineColor: 'rgba(0, 0, 0, 0.2)',
            highlightSpotColor: 'rgb(24, 107, 42)'
        });
